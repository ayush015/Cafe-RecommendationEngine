...
namespace RecommendationEngineServer
{
    ...
    //                       options => options.UseSqlServer("Server=ITT-AYUSH-SRIV\\SQLEXPRESS;Database=RecommendationEngineDB;Trusted_Connection=True;TrustServerCertificate=True"),ServiceLifetime.Scoped
    //                       );
        ...
        public static async Task<IHostBuilder> CreateHostBuilder(string[] args)
        {
            return await Task.FromResult(Host.CreateDefaultBuilder(args)
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    // Register ClientHandler as scoped to allow DI
