...
namespace RecommendationEngineServer.DAL.Migrations
{
    ...
    [Migration("20240703113934_AddedMenuFeedbackQuestionAndUserMenuFeedbackAnswerTable")]
    partial class AddedMenuFeedbackQuestionAndUserMenuFeedbackAnswerTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecommendationEngineServer.DAL.Models.UserMenuFeedbackAsnwer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ImprovementQuestionId")
                        .HasColumnType("int");

                    b.Property<int?>("ImprovementQuestionsId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ImprovementQuestionsId");

                    b.HasIndex("MenuId");

                    b.HasIndex("UserId");

                    b.ToTable("UserMenuFeedbackAsnwer");
                });
            ...
            modelBuilder.Entity("RecommendationEngineServer.DAL.Models.UserMenuFeedbackAsnwer", b =>
                {
                    b.HasOne("RecommendationEngineServer.DAL.Models.MenuFeedbackQuestion", "ImprovementQuestions")
                        .WithMany()
                        .HasForeignKey("ImprovementQuestionsId");
                    ...
                    b.Navigation("ImprovementQuestions");
